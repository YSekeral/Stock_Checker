...
Connection.starttls()
Connection.login(password=APP_KEY,user="ygtskrltr@gmail.com")
...
try:
    ...
    for articles in formatted_articles:
        msg = MIMEMultipart()
        msg["From"] = "ygtskrltr@gmail.com"
        msg["To"] = "mysekeralusa@gmail.com"
        msg["Subject"] = f"{Arrow}{"{:.2f}".format(percentage)} {COMPANY_NAME} Stock Alert"

        msg.attach(MIMEText(articles, "plain", "utf-8"))

        Connection.sendmail(
            from_addr="ygtskrltr@gmail.com",
            to_addrs="mysekeralusa@gmail.com",
            msg=msg.as_string()
        )
except NameError:
